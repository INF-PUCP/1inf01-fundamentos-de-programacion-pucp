...
Acabo de terminar Estudios Generales Ciencias y me gustaría compartir este repositorio con recomendaciones para el curso de "funpro", así como mi intento fallido de querer subir el solucionario de todos los problemas de laboratorio (el cual no lo concluí pues los problemas me parecieron repetitivos y aburridos) y una carpeta extra llamada "Problemas interesantes" con ciertos problemas resueltos en PSeInt que, en mi opinión, eran bonitos de implementarlos, la mayoría de estos abarcan principios elementales que se ven en los cursos de matemáticas como operaciones matriciales, operaciones con polinomios como derivar o dividir, determinar si un número es primo analizando hasta la raíz y otras cosas más (No garantizo que las versiones en C de los problemas interesantes compilen pues fueron generadas automáticamente con la opción de exportar que tiene PSeInt). Espero que les sea de utilidad y puedan aprender algo leyendo los códigos o los tips a continuación.
